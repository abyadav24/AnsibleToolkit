...
from ilorest.rdmc_helper import ReturnCodes, InvalidCommandLineErrorOPTS, InvalidFileInputError, \
                    UI
...
class MonolithCommand():
    ...
    def definearguments(self, customparser):
        ...
        customparser.add_argument(
            ...
            '--filename',
            dest='filename',
            help="Use this flag if you wish to save the monolith"\
        ...
        customparser.add_argument(
            ...
            dest='redmono',
            action="store_true",
            help="Use this flag if you wish to save the reduced monolith"\
            " into a file with the given filename.",
            default=False
        )
