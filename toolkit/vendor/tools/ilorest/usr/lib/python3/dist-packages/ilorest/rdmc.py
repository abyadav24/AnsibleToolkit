...
from ilorest.rdmc_helper import ReturnCodes, RdmcError, ConfigurationFileError, CommandNotEnabledError, \
...
class RdmcCommand(RdmcCommandBase):
    ...
    def __init__(self, name, usage, summary, aliases, argparser, Args=None):
        ...
        for name in extensions.classNames:
            ...
            pkgName = 'ilorest.extensions' + pkgName
            try:
                ...
                self.ui.error(("loading command: {}: {}".format(cName, excp)), None)
