...
if not os.path.exists(vendor_path):
    ...
    if os.path.exists(cwd_vendor):
        ...
        # Try finding the toolkit directory in common locations
        possible_paths = [
            '/home/ubuntu/smci/AnsibleToolkit/toolkit/vendor/python-libs',
            os.path.join(os.path.dirname(os.path.dirname(os.path.dirname(script_dir))), 'toolkit', 'vendor', 'python-libs'),
